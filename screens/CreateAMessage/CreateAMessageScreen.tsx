    ...
    <View style={styles.screen}>
      <ScrollView>
        <ImageBackground source={require('../../assets/images/dashboard_background.png')} style={styles.background}>
            ...
            <NavigationCard CardType="CreateAMessage" text='Early Warning Signs' subheading="Keep track of your behaviours to keep your health in check" link='ContentImport' linkType={LinkType.Screen} category={CategoryType.EarlyWarning} height={Layout.window.width * 0.2} width={Layout.window.width * 0.8}></NavigationCard>
            <NavigationCard CardType="CreateAMessage" text='Places to Go' subheading="Need a break? Get some fresh air and visit these local areas" link='ContentImport' linkType={LinkType.Screen} category={CategoryType.Places} height={Layout.window.width * 0.2} width={Layout.window.width * 0.8}></NavigationCard>
            <NavigationCard CardType="CreateAMessage" text='Things I love' subheading="Remember all the little things that make living great!" link='ContentImport' linkType={LinkType.Screen} category={CategoryType.Love} height={Layout.window.width * 0.2} width={Layout.window.width * 0.8}></NavigationCard>
